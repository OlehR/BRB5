...
namespace BRB5
{
    public enum eKindDoc { NotDefined=0, Normal=1, Simple=2, PriceCheck=3, RaitingDoc=4, RaitingTempate=5, RaitingTemplateCreate=6, PlanCheck=7, ExpirationDate=8, LotsCheck=9, Lot=10, NormalNoEdit=11,DocCheck=12}
